...
int_period <- function(x = integer(), n = 1L, origin = 0L) {
    .Defunct(
        package = "grates",
        msg = "As of version 1.0.0 the int_period function is defunct"
    )
}
...
as_int_period <- function(x, ...) {
    .Defunct(
        package = "grates",
         msg = "As of version 1.0.0 the as_int_period function is defunct"
    )
}
...
is_int_period <- function(x) {
    .Defunct(
        package = "grates",
        msg = "As of version 1.0.0 the is_int_period function is defunct"
    )
}
...
scale_x_grates_int_period <- function(n.breaks = 6, n, origin) {
    .Defunct(
        package = "grates",
        msg = "As of version 1.0.0 the scale_x_grates_int_period function is defunct"
    )
}

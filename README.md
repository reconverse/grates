...
For each of the grouped date classes, **grates** also provides *scales*
to use with [ggplot2](https://cran.r-project.org/package=ggplot2). At
the same time **grates** has no strong dependencies so is also well
suited to more minimal analytical pipelines.

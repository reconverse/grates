...
test_that("as.POSIXct.yearweek works as expected", {
  ...
  expect_equal(res, as.POSIXct(as.POSIXlt(dat, tz = "UTC")))
})
...
test_that("as.POSIXlt.yearweek works as expected", {
  ...
  expect_equal(res, as.POSIXlt(dat, tz = "UTC"))
})
...
test_that("as.list.yearweek works as expected", {
  dat <- as_yearweek(c(a = "2020-12-28", b = "2021-01-04"))
  res <- list(a = as_yearweek("2020-12-28"), b = as_yearweek("2021-01-04"))

...
multiple grouped date classes for users to work with including *grates_yearweek*,
*grates_month*, *grates_quarter*, *grates_year*, *grates_period* and
*grates_int_period*.  These classes aim to formalise the idea of a grouped date
...
## grates_yearweek
`as_yearweek()` allows you to create <grates_yearweek> objects. As arguments it
...
takes, `x`, the date vector you wish to group, `n`, the number of months
you wish to group by (defaulting to 1) and, finally, `origin`, an optional value
indicating where you would like to start your periods from relative to the Unix
Epoch (1970-01-01). By default the provided scale creates a histogram-like
